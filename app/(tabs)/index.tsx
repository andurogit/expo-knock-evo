...
const MOCK_POLICIES: Policy[] = [
  {
    ...
    location: "Seoul",
    description:
      "Providing monthly rent support up to 200,000 KRW for young adults living alone in Seoul for up to 12 months.",
  ...
  },
  {
    ...
    description:
      "Support for freelancers starting their own business. Grants up to 5,000,000 KRW for office space and equipment.",
  ...
  },
  {
    ...
    location: "Incheon",
    description:
      "Direct financial support for families with children under the age of 5. Includes childcare voucher and cash support.",
    ...
    >
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          ...
          router.push(`/policy/${item.id}` as Href);
        }}
      >
